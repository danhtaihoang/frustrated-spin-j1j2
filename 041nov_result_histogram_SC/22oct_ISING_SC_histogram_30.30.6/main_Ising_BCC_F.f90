...
!Mz(1) la Mz_F1; Mz(2) la Mz_AF1; Mz(3),M(4),M(5) la Mz_SC cua tung truong hop, ,
                        IF (l==1) THEN
                              Mz(1)=Mz(1) + (((-1.)**mod(i+j,2))+((-1.)**mod(i+k,2))+((-1.)**mod(j+k,2)))*tab_spin_a(i,j,k,1)
                              Mz(2)=Mz(2) + ((-1.)**mod(i+j+k,2))*tab_spin_a(i,j,k,1)
                              Mz(3)=Mz(3) + ((-1.)**mod(i+j,2))*tab_spin_a(i,j,k,1)
                              Mz(4)=Mz(4) + ((-1.)**mod(i+k,2))*tab_spin_a(i,j,k,1)
                              Mz(5)=Mz(5) + ((-1.)**mod(j+k,2))*tab_spin_a(i,j,k,1)
                        END IF  
