...
!*==*===*==*==*==*==*==*==*===*==*==*==*==*==*==*===*==*==*==*==*==*==*===*==*==*==*==*==*==*==*==*== 
      ...
      CHARACTER (LEN=150):: CONF,RELOAD,DISTRI
      ...
      REAL    (KIND=8) :: temp_min,temp_max,EN_tmp1,EN_tmp2,EN_tmp,valeu_T
...
!_____________________________________________________________________________________________________
 SUBROUTINE read_input_parameter_file()
      ...
      IF (DISTRI=='YES') THEN
            OPEN(200,file='parameter_2.in')
            READ(200, '(A50)')         tamp
            READ(200, '(A30,(F7.4))')  tamp, valeu_T
            CLOSE(200)
            temp_min=valeu_T
      ENDIF
